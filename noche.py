...
rutina_imagenes = {
    "8 D": pygame.transform.scale(pygame.image.load("imagenes/8 D.jpg").convert_alpha(), (150, 150)),
    "3 N": pygame.transform.scale(pygame.image.load("imagenes/3 N.jpg").convert_alpha(), (150, 150)),
    "1 N": pygame.transform.scale(pygame.image.load("imagenes/1 N.jpg").convert_alpha(), (150, 150)),
    "2 N": pygame.transform.scale(pygame.image.load("imagenes/2 N.jpg").convert_alpha(), (150, 150)),
}
...
def calcular_posiciones_cuadricula(imagenes, num_columnas, separacion):
    ...
    for i in range(num_imagenes):
        ...
        y = 90 + fila * (imagenes[i].get_height() + separacion)
...
orden_correcto = ["1 N","2 N", "8 D","3 N" ]
...
while ejecutando:
    ...
    titulo = title_font.render("Noche", True, BLANCO)
